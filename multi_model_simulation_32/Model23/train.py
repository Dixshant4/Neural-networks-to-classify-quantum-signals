...
def get_prediction(model, data, sample=1000, device=torch.device("cuda" if torch.cuda.is_available() else "cpu")):
...
torch.save(model.state_dict(), os.path.join(script_directory, 'model23.pth'))
